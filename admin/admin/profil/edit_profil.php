      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">EDIT TIM
        </div>
...
$hasil = mysqli_query($koneksi, $edit); // Ganti mysql_query dengan mysqli_query
$c = mysqli_fetch_array($hasil); // Ganti mysql_fetch_array dengan mysqli_fetch_array
?>
